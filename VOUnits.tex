...
%\definecolor{normative}{rgb}{0.1,0.1,0.5}
...
\editor{S\'{e}bastien Derri\`{e}re and Norman Gray}

\urlthisversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/20140226/}}}
\urllastversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/}}}
\previousversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/20131224/}}}
%\previousversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/20130922/}}}
%\previousversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/20131011/}}}
%\previousversion{\footnotesize{\url{http://www.ivoa.net/documents/VOUnits/20130724/PR-VOUnits-1.0-20130922.pdf}}}
...
custom unit such as 'jupMass'; see \prettyref{sec:quoting}), that the
...
with scalefactors (cf \prettyref{sec:scaleFactors}).
\end{itemize}
...
Note: the~`s' and~`b' annotations in \prettyref{tabx:knownunits}
are not symmetric: the~`s' annotation indicates that SI
prefixes are permitted in the given syntax, which means that they are
also recognised when preceding unknown units (which have no
restrictions on them); in contrast, binary prefixes are recognised
exclusively on units with a~`b' annotation, which means that they
are \emph{not} recognised with unknown units.  That is,
the \unit{Mifurlong} is the mega-\texttt{ifurlong} and
the \unit{Kifurlong} is the unknown unit \texttt{Kifurlong}.
...
\begin{table}[ht]
  \begin{tabular}{|L{0.2\linewidth}|p{0.12\linewidth}|p{0.12\linewidth}|p{0.12\linewidth}|p{0.12\linewidth}|p{0.12\linewidth}|}
\hline
...
\begin{table}[ht]
\begin{tabular}{|L{0.2\linewidth}|L{0.12\linewidth}|L{0.12\linewidth}|L{0.12\linewidth}|L{0.12\linewidth}|L{0.12\linewidth}|}
\hline
    & IAU & OGIP  & StdCats & FITS  & VOUnits\\\hline
    ...
    \cline{2-5}
    planar and solid angle&  &  &  & (2) & \\\hline
    Derived units & \multicolumn{4}{c|}{\unit{Hz, N, Pa, J, W, C, V,}} & \\
    with symbols & \multicolumn{4}{c|}{\unit{S, F, Wb, T, H, lm, lx}} & idem \\
...
plus the extra ones listed in \prettyref{tabx:vounitsterminals})
and by the list of known units of \prettyref{tabx:knownunits}.
