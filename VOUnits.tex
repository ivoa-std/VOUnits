...
\urlthisversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/20131224/}}}
\urllastversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/}}}
\previousversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/20131025/}}}
...
The unit string \unit{unknown} (in lower-case) is reserved for cases
when the unit is unknown; that is, it is known that there should be a
unit, but the unit string has been lost or not been specified.  It is
not, however, part of the list of known units or the VOUnits grammar,
and applications \norm{must} check for its presence before unit parsing.
...
\unit{ph} or \unit{photon} 	&\unit{adu}                     &\unit{D} (Debye)	&\unit{unknown} (unknown; see \prettyref{sec:parsing-components})\\\hline
\end{tabular}
\end{center}
...
milli-furlong, and \unit{m'm'} is a milli-`m'.
