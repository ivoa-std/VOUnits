...
\previousversion[https://www.ivoa.net/documents/VOUnits/20230502]{PR-1.1-20230502}
\previousversion[https://ivoa.net/documents/VOUnits/20220525/]{WD-1.1 2022-05-25}
...
\prettyref{sec:useCase} lists some use cases and reference implementations.
In \prettyref{appx:current},
...
Besselian and tropical years (FITS\,4 remarks that use of either of
...
is a VOUnit parser.   The Unity library \cite{unity-1.1} is a
...
The Unity library \cite{unity-1.1} is a
...
ADQL 2.1 will offer the
\verb|IN_UNIT(expr, to_unit)|
function as a mitigation.\footnote{As of the release of VOUnits 1.1,
ADQL~2.1 is still a Proposed Recommendation.  See
\url{https://www.ivoa.net/documents/ADQL/20210528/index.html} for the
current status.}
When an ADQL engine can establish the
...
The grammars here are from release 1.1 of the `Unity' package \cite{unity-1.1},
which includes machine-readable
...
the FITS specification is not completely clear on the topic of
