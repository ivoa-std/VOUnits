...
\urlthisversion{\footnotesize{\url{http://www.ivoa.net/Documents/VOUnits/20131025/}}}
...
\norm{may},
\norm{optional},
thus formatted, are to be interpreted as described in
\cite{std:rfc2119}.
...
because the presence of a bare unit would be ungrammatical).  We can
think of no cases where the ambiguity is plausible enough that
resolving it is worth the specification effort, so we deem the parse
of \texttt{da.*} to be \textbf{unspecified}.
