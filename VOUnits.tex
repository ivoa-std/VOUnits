...
A programme implementing the rules laid down in \prettyref{sec:proposal}
is a VOUnit parser.   The
Unity library\footnote{\url{https://bitbucket.org/nxg/unity}} is a
...
Programmes may want to parse units for a variety of reasons:
...
\item Programmatic manipulation of units.  For example, a programme may
...
The Unity library\footnote{\url{https://purl.org/nxg/dist/unity}} is a new
...
same. For example, a programme may want to convert a distance
...
% These grammars are extracted from http://hg.sr.ht/~nxg/unity:
%     % cd src/grammars
...
The grammars here are from release 1.1-SNAPSHOT of the `Unity' package at
\url{https://hg.sr.ht/~nxg/unity}, which includes machine-readable
grammars, lists of recommended units, and a collection of test cases.  These are also extracted in
machine-readable form
at \url{https://github.com/ivoa-std/VOUnits/blob/master/unity-grammars.zip}.
