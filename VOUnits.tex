...
scaling prefix (\prettyref{sec:scaleFactors}).
...
with scaling prefixes (cf \prettyref{sec:scaleFactors}).
\end{itemize}
...
Although the SI prefixes of \prettyref{sec:scaleFactors} are part of
...
plus
the SI scaling prefixes of \prettyref{sec:scaleFactors},
