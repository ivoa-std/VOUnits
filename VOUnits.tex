...
factor for \unit{a}). One must not use compound prefixes (that is,
...
\begin{table}
\begin{tabular}{lll}
\textbf{unit}&\textbf{interpretation}&\textbf{not}\\
Pa&pascal&peta-year\\
ha&hecto-year&hectare\\
cd&candela&centi-day\\
au&atto-atomic-mass&astronomical unit\\
\end{tabular}
\caption{\label{tab:ambiguous}Ambiguous units}
\end{table}
...
There are a few units (namely `pix/pixel', `ph/photon' and `a/yr') for
